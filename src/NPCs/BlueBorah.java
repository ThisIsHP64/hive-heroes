...
public class BlueBorah extends NPC {

    public BlueBorah(int id, Point location) {
        super(id, location.x, location.y, new SpriteSheet(ImageLoader.load("BlueBorahFlower.png"), 20, 20),
                "STAND_LEFT");
    }
