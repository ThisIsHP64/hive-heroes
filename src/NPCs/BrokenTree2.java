...
public class BrokenTree2 extends NPC {

    private static final int SPRITE_WIDTH = 64;
    private static final int SPRITE_HEIGHT = 64;
    private static final float SCALE = 5f;

    public BrokenTree2(int id, Point location) {
        super(
            id,
            location.x,
            location.y,
            new SpriteSheet(ImageLoader.load("BrokenTree2.png"), SPRITE_WIDTH, SPRITE_HEIGHT, 0),
            "GRAVE"
        );
    }
